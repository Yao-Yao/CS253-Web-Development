...
class UserloginPage(webapp2.RequestHandler):
    def get(self):
        #f=open('userlogin.html', 'r')
        self.response.out.write(userlogin_html % {'name':'',
                                                 'pwd1':'',
                                                 'pwd2':'',
                                                 'emailaddr':'',
                                                 'err_name':'',
    ...
    def post(self):
        ...
        if not err_name and not err_pwd1 and not err_pwd2 and not err_emailaddr:
            ...
            self.response.out.write(userlogin_html % {'name':usr_name,
                                                     'pwd1':usr_pwd1,
                                                     'pwd2':usr_pwd2,
...
##app = webapp2.WSGIApplication([('/userlogin', MainPage),
##                               ('/thanks', UserloginPage)],
##                              debug=True)
